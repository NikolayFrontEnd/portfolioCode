    ...
    <>
      ...
      <div className="hospital-container">
        <div className="hospital-header">
          <span className="hospital-badge">BOTHAB assistent</span>
          <h1 className="hospital-title">{t('Bothab')}</h1>
        </div>
        ...
        <div className="hospital-content">
          ...
          <div className="description-section">
            <div className="description-content">
              <p className="description-text">{t('bothabDesc')}</p>

              <p className="description-text">{t('bothabDesc2')}</p>

              <p className="description-text">{t('bothabDesc3')}</p>
