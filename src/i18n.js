...
const resources = {
  en: {
    translation: {
      ...
      stivPort:
        'I designed a clean portfolio card featuring a neat layout with an avatar, social links, and a contact button. I focused on typography, spacing, and a modern visual style to keep the card simple, readable, and professional.',
      stivPort1:
        'I designed a clean portfolio card featuring a neat layout with an avatar, social links, and a contact button. I focused on typography, spacing, and a modern visual style to keep the card simple, readable, and professional.',

      articleApp:
        'I built the frontend for this programming articles web app as a freelance project. The Node.js backend was already in place, and my responsibility was to implement the UI and connect it to the existing API—handling requests, responses, loading/error states, and smooth navigation across the content.',
      articleApp1:
        'The app lets users create their own articles, edit or delete them, and save favorite posts to a favorites list. I focused on a clean, intuitive interface and reliable client–server interaction so the core workflows feel fast and consistent.',
      ...
      description2:
        'Proficient in React, Next.js, Nest.js, Node.js, Django and',
      ...
      skill_react_desc:
        'After learning HTML, CSS, and JavaScript, I decided to deepen my knowledge and started learning a new frontend development library - React. With this library, I have created over 5 different web applications and numerous single-page landing sites.',
      skill_node_title: 'Node JS',
      skill_node_desc:
        'After mastering frontend, I decided to study backend development to be able to create my own web applications independently and become a full-stack developer. I learned the main backend concepts and widely applied them in my own projects.',
      skill_native_title: 'React Native',
      skill_native_desc:
        'I also studied React Native to create mobile applications and developed several simple apps, such as a calendar, a Todo List, and an achievement list.',
      skill_next_title: 'Next.js',
      skill_next_desc:
        'I am proficient in Next.js and can develop both frontend and backend using this framework. I am experienced with server-side logic, APIs, and client-side rendering.',
      skill_mongo_title: 'Mongo DB',
      skill_mongo_desc:
        'To create full-fledged web applications, I studied a non-relational database to store data within it. This database provides flexibility in storing unstructured data and ensures scalability and high performance.',
      skill_sql_title: 'Microsoft SQL Server',
      skill_sql_desc:
        'I also learned SQL and Microsoft SQL Server to store data in a relational database and become a more effective developer.',
      skill_three_title: 'Three.JS',
      skill_three_desc:
        'I have experience in creating interactive 3D animations and websites using Three.js, including data visualization, effects, and complete 3D scenes. This allows me to add unique visual elements to websites, enhancing user experience and making projects more impressive and interactive.',
      skill_tailwind_title: 'TailWind',
      skill_tailwind_desc:
        'Experience with TailwindCSS allows me to quickly and efficiently style interfaces, creating adaptive and modern designs. Using utility classes speeds up development and ensures style consistency, making projects flexible and easy to maintain.',
      skill_bootstrap_title: 'Bootstrap',
      skill_bootstrap_desc:
        'I also know Bootstrap, which allows me to create adaptive and cross-browser interfaces very quickly and efficiently.',
      skill_redux_title: 'Redux',
      skill_redux_desc:
        'Experience with Redux helps me manage state effectively in complex applications, creating scalable architecture, ensuring predictability, and easy debugging.',
      skill_typescript_title: 'TypeScript',
      skill_typescript_desc:
        'Experience with TypeScript helps me write safe and predictable code using strong typing. Using TypeScript makes my projects more reliable and helps to work more efficiently in a team due to autocompletion and static type checking.',
      skill_django_title: 'Django',
      skill_nest_desc:
        'I have experience working with Nest.js, creating server-side applications and REST APIs. I am skilled in designing server-side architecture and effectively implementing functionality to support modern web applications.',
      skill_django_desc:
        'I have also learned Python and Django, allowing me to create full-fledged backend solutions not only with Node.js but also with this platform, integrating them with frontend and ensuring the reliability and security of applications.',
      skill_postgresql:
        'I have basic knowledge of working with PostgreSQL, including creating tables, executing queries, and managing data. I am capable of using SQL to implement CRUD operations and optimize data handling.',
      sport:
        'During development, I used modern responsive design to create an intuitive and visually appealing interface. This project helped me not only improve my React skills but also understand the principles of good user experience (UX) and adapting content for various devices. Although the site is built only with React, it gave me valuable experience in creating an interactive frontend and using a component-based approach.',
      sport1:
        'After completing React courses, I decided to start testing my skills and creating different websites. I really love sports, and for this reason, I decided to practice by making my own website where you can see famous athletes, their training routines, and diets. This project fascinated me so much that I completed it quickly and was able to reinforce my React knowledge in practice.',
      ...
      cats1:
        'I implemented dynamic content loading with performance optimization and intuitive navigation. This project highlights my skills in creating modern, visually appealing, and high-performance web applications.',
      ...
      sport1:
        'I implemented functionality to display the list of athletes and details of their workouts, focusing on usability and intuitive navigation. This project was a key milestone in mastering React and database integration, highlighting my ability to build functional web applications.',
      ...
      dgame1:
        'I implemented a level navigation system and information presentation, focusing on intuitive design and performance optimization. This project showcases my expertise in modern frameworks and crafting engaging user interfaces.',
    },
  },
  ru: {
    translation: {
      ...
      stivPort:
        'Я создал стильную карточку портфолио с аккуратной компоновкой, аватаром, ссылками на соцсети и кнопкой связи. В процессе уделил внимание типографике, отступам и современному визуальному стилю, чтобы карточка выглядела легко и профессионально.',
      stivPort1:
        'Этот проект я выложил на YouTube как часть своего хобби — мне нравится делать красивые дизайны и превращать идеи в понятные, эстетичные интерфейсы. Продолжаю экспериментировать с UI, цветами и анимациями, чтобы прокачивать вкус и навыки.',

      articleApp:
        'Это веб‑приложение со статьями для программистов я выполнял как фриланс‑проект. Бэкенд на Node.js уже был готов, а моя задача заключалась в разработке фронтенда и его интеграции с API: настроить запросы, обработку ответов, состояния загрузки/ошибок и удобную навигацию по материалам.',
      articleApp1:
        'Приложение позволяет создавать собственные статьи, редактировать и удалять их, а также добавлять понравившиеся публикации в избранное. Я сфокусировался на понятном интерфейсе, аккуратной верстке и стабильной работе всех пользовательских сценариев, чтобы пользоваться платформой было быстро и приятно.',
      // Основной компонент Main
      greeting: 'Я',
      name: 'Николай,',
      ...
      description3:
        'базами данных, такими как MongoDB, SQL Server, PostgreSQL.',
      ...
      skill_react_title: 'React',
      skill_react_desc:
        'После изучения HTML, CSS и JavaScript, я решил углубить свои знания и начал изучать новую библиотеку для Frontend разработки - React. С помощью этой библиотеки я создал более 5 разных веб-приложений и множество одностраничных лендингов.',
      skill_node_title: 'Node JS',
      skill_node_desc:
        'После изучения Frontend, я решил начать изучать Backend, чтобы самостоятельно создавать собственные веб-приложения и считать себя Full-stack разработчиком. Я изучил основные концепции Backend и широко их применял в своих проектах.',
      skill_native_title: 'React Native',
      skill_native_desc:
        'Также я изучил React Native для создания мобильных приложений и создал несколько простых приложений, таких как календарь, Todo List и список достижений.',
      skill_next_title: 'Next.js',
      skill_next_desc:
        'Я хорошо владею Next.js и могу разрабатывать как фронтенд, так и бэкенд с использованием этого фреймворка. Умею работать с серверной логикой, API и рендерингом на стороне клиента.',
      skill_mongo_title: 'Mongo DB',
      skill_mongo_desc:
        'Для создания полноценных веб-приложений я изучил нереляционную базу данных, чтобы хранить данные в ней. Эта база данных обеспечивает гибкость в хранении неструктурированных данных, а также масштабируемость и высокую производительность.',
      skill_sql_title: 'Microsoft SQL Server',
      skill_sql_desc:
        'Я также изучил язык SQL и базу данных Microsoft SQL Server, чтобы иметь возможность хранить данные в реляционной базе данных и быть более эффективным разработчиком.',
      skill_three_title: 'Three.JS',
      skill_three_desc:
        'У меня есть опыт создания интерактивных 3D-анимаций и сайтов с использованием Three.js, включая визуализацию данных, эффекты и полные 3D-сцены. Это позволяет мне добавлять уникальные визуальные элементы на сайты.',
      skill_tailwind_title: 'TailWind',
      skill_tailwind_desc:
        'Опыт работы с TailwindCSS позволяет мне быстро и эффективно стилизовать интерфейсы, создавая адаптивные и современные дизайны. Использование утилитарных классов ускоряет разработку и обеспечивает единообразие стилей.',
      skill_bootstrap_title: 'Bootstrap',
      skill_bootstrap_desc:
        'Я также знаком с Bootstrap, что позволяет мне быстро создавать адаптивные и кроссбраузерные интерфейсы.',
      skill_redux_title: 'Redux',
      skill_redux_desc:
        'Опыт работы с Redux помогает мне эффективно управлять состоянием в сложных приложениях, создавать масштабируемую архитектуру, обеспечивать предсказуемость и упрощать отладку.',
      skill_typescript_title: 'TypeScript',
      skill_typescript_desc:
        'Опыт работы с TypeScript помогает мне писать безопасный и предсказуемый код с использованием строгой типизации. Использование TypeScript делает мои проекты более надежными.',
      skill_django_title: 'Django',
      skill_nest_desc:
        'Я обладаю опытом работы с Nest.js, создавая серверные приложения и REST API. Умею проектировать архитектуру серверной части и эффективно реализовывать функционал для поддержки современных веб-приложений.',
      skill_django_desc:
        'Также я изучил Python и Django, что позволяет мне создавать полноценные backend-решения не только на Node.js, но и на этой платформе, интегрируя их с фронтендом и обеспечивая надежность и безопасность приложений.',
      skill_postgresql:
        'Я обладаю базовыми знаниями работы с базой данных PostgreSQL, включая создание таблиц, выполнение запросов и управление данными. Умею использовать SQL для реализации CRUD-операций и оптимизации работы с данными.',
      sport1:
        '  После прохождения курсов по React, я решил начать пробовать свои силы и создавать разные веб-сайты. Я очень люблю спорт и, по этой причине, решил потренироваться и сделать свой собственный сайт, на котором можно увидеть известных спортсменов, их виды тренировок и режим питания. Этот проект меня так захватил, что я быстро его завершил и смог закрепить свои знания React на практике.',
      sport:
        'При разработке я использовал современный адаптивный дизайн, чтобы создать интуитивно понятный и визуально привлекательный интерфейс. Этот проект помог мне не только улучшить навыки работы с React, но и понять принципы хорошего пользовательского опыта (UX) и адаптации контента для различных устройств. Хоть сайт и написан только на React, он дал мне ценный опыт по созданию интерактивного фронтенда и использованию компонентного подхода.',
      ...
      dict2:
        "Одной из главных функций приложения является игра 'Напиши правильный перевод слова', которая помогает запоминать слова в увлекательной и интерактивной форме. Пользователи могут отслеживать свой прогресс и результаты, что делает изучение более мотивирующим и увлекательным.",
      dict3:
      ...
      uniWebsite:
        'В моей первой компании Dunice, работая фулстек-разработчиком, я участвовал в создании LMS-платформы для университета на основе React, Nest.js и MongoDB. Моя задача включала разработку системы регистрации студентов на сдачу работ, отображение списка студентов и управление очередью для контроля процесса сдачи.',
      uniWebsite1:
        'Я реализовал функционал регистрации на бэкенде и фронтенде, а также добавил возможность добавления студентов в очередь. Этот проект демонстрирует мои навыки фулстек-разработки и создания эффективных образовательных решений.',
      ...
      cats1:
        'Я реализовал динамическую подгрузку контента с оптимизацией производительности и интуитивно понятной навигацией. Этот проект подчеркивает мои навыки создания современных, визуально привлекательных и высокопроизводительных веб-приложений.',
      ...
      sport1:
        'Я реализовал функционал для отображения списка спортсменов и деталей их тренировок, уделяя внимание удобству и простоте навигации. Этот проект стал важным этапом в освоении React и работе с базами данных, демонстрируя мои навыки создания функциональных веб-приложений.',
      dgameTitle: 'Веб игра с историей про космос',
      dgame:
        'В компании Storytelling Software, работая фронтенд-разработчиком, я создавал веб-приложение на основе Next.js и Tailwind CSS, представляющее собой интерактивную игру, где пользователи проходят уровни и изучают информацию. Моя задача заключалась в разработке адаптивного и визуально привлекательного интерфейса, обеспечивающего плавное прохождение уровней и удобное чтение контента.',
      dgame1:
        'Я реализовал систему навигации по уровням и отображение информации с акцентом на интуитивный дизайн и оптимизацию производительности. Этот проект демонстрирует мои навыки работы с современными фреймворками и создания увлекательных пользовательских интерфейсов.',
    },
  },
};
