      ...
      <div className="container5">
        ...
        <div className="card" style={{ '--clr': '#009688' }}>
          ...
          <div className="content">
            <h2>
              <span className="reactColor">{t('skill_react_title')}</span>
            </h2>
        ...
        <div className="card" style={{ '--clr': '#FF3E7F' }}>
          ...
          <div className="content">
            <h2>
              <span className="nodWord">{t('skill_node_title')}</span>
            </h2>
        ...
        <div className="card" style={{ '--clr': '#03A9F4' }}>
          ...
          <div className="content">
            <h2>
              <span className="nestW">Nest.js</span>
            </h2>
        ...
        <div className="card" style={{ '--clr': '#03A9F4' }}>
          ...
          <div className="content">
            <h2>
              <span className="Next">{t('skill_next_title')}</span>
            </h2>
        ...
        <div className="card" style={{ '--clr': '#03A9F4' }}>
          ...
          <div className="content">
            <h2>
              <span className="mongoColor">{t('skill_mongo_title')}</span>
            </h2>
        ...
        <div className="card" style={{ '--clr': '#03A9F4' }}>
          ...
          <div className="content">
            <h2>
              <span className="msServer">{t('skill_sql_title')}</span>
            </h2>
        ...
        <div className="card" style={{ '--clr': '#03A9F4' }}>
          ...
          <div className="content">
            <h2>
              <span className="reactNW">{t('skill_native_title')}</span>
            </h2>
        ...
        <div className="card" style={{ '--clr': '#03A9F4' }}>
          ...
          <div className="content">
            <h2>
              <span className="threeColor">{t('skill_three_title')}</span>
            </h2>
        ...
        <div className="card" style={{ '--clr': '#03A9F4' }}>
          ...
          <div className="content">
            <h2>
              <span className="TailWindWord">{t('skill_tailwind_title')}</span>
            </h2>
        ...
        <div className="card" style={{ '--clr': '#03A9F4' }}>
          ...
          <div className="content">
            <h2>
              <span className="bwords24">{t('skill_bootstrap_title')}</span>
            </h2>
        ...
        <div className="card" style={{ '--clr': '#03A9F4' }}>
          ...
          <div className="content">
            <h2>
              <span className="redWords">{t('skill_redux_title')}</span>
            </h2>
        ...
        <div className="card" style={{ '--clr': '#03A9F4' }}>
          ...
          <div className="content">
            <h2>
              <span className="DjangoW">{t('skill_django_title')}</span>
            </h2>
